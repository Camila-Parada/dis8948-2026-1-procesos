...
Primera sesión: https://field-mine-ef5.notion.site/Interacciones-Digitales-dis8948-31151d9cbb998078b0cdec5c39fa3ec8
...
Comprende reciprocidad, contextos, objetivos.

En una "interacción digital" se requiere que una de las partes sea un ente digital y otro humano.

***

## La interacción como "Conversación" (Ranulph Glanville)

(Cibernetica) La verdadera interacción no es solo una reacción, sino un proceso circular en el que se "habla", se "escucha" y se "responde". Ello transforma la interacción en un bucle en el que la salida de la máquina se convierte en la entrada del humano y vice versa. (Una interacción similar a una conversación con un chatbot).
